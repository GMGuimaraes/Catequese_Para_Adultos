...
router.get("/findbypk/pessoa/:cpf", findPessoa.handle);
router.get("/findbypk/sacramento/:idSacramento", findSacramento.handle);
router.get("/findbypk/padrinhomadrinha/:cpfPessoa", findPadrinhoMadrinha.handle);
...
router.patch("/update/pessoa/:cpf", updatePessoa.handle);
router.patch("/update/sacramento/:idSacramento", updateSacramento.handle);
router.patch("/update/padrinhomadrinha/:cpfPessoa", updatePadrinhoMadrinha.handle);
...
router.delete("/delete/pessoa/:cpf", deletePessoa.handle);
router.delete("/delete/sacramento/:idSacramento", deleteSacramento.handle);
router.delete("/delete/padrinhomadrinha/:cpfPessoa", deletePadrinhoMadrinha.handle);
